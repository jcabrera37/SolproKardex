                            ...
                            <div class="card" style="padding-right: 10px;">
                                <div class="card-body" style="padding-right: 10px;">
                                    ...
                                    <form class="form-inline" action="buscarProducto.php" method="post" style="padding-right: 3px;">
                                        ...
                                        <div class="col-xs-12 col-sm-2 input-position text-rigth">
                                        <div class="panel-body"><!-- INICIO MODAL -->
                                            <div class="form-control">
                                                <button href="#cart" title="" data-toggle="modal" class="mdi mdi-cart"  data-original-title="Venta" type="button"> 
                                                </button>
                                            </div>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <h3 id="myModalLabel" align="center" >Productos</h3>
                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">X</button>
                                                        </div>
                                                        
                                                        <div class="modal-body">
                                                            <div class="table-responsive">
                                                                <h3>Nombre: Cliente test</h3>
                                                                <h3>Dirección: Ciudad</h3>
                                                                <h3>Nit: 32342342</h3>
                                                        ...
                                                        <div class="modal-footer">
                                                            <button name="btnfactua" href="facturar.php" type="button" class="btn btn-primary"><strong><a href="facturar.php" class="a-button">Facturar</a></strong></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
